...
public final class CharBufferImpl extends CharBuffer
{
  ...
  final public CharBuffer putChar (char value)
  {
    return put (value);
  }
  ...
  final public CharBuffer putChar (int index, char value)
  {
  ...
  final public CharBuffer putShort (short value)
  {
  ...
  final public CharBuffer putShort (int index, short value)
  {
  ...
  final public CharBuffer putInt (int value)
  {
  ...
  final public CharBuffer putInt (int index, int value)
  {
  ...
  final public CharBuffer putLong (long value)
  {
  ...
  final public CharBuffer putLong (int index, long value)
  {
  ...
  final public CharBuffer putFloat (float value)
  {
  ...
  final public CharBuffer putFloat (int index, float value)
  {
  ...
  final public CharBuffer putDouble (double value)
  {
  ...
  {
    double a = nio_get_Double (this, index, limit ());
    return a;
  }

  final public CharBuffer putDouble (int index, double value)
  {
